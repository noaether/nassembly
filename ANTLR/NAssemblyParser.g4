...
value: HEX_NUMBER | FLOAT_NUMBER | BIN_NUMBER | functioncall | IDENTIFIER | STRING_VALUE | CHAR_VALUE | OPEN_PAREN value CLOSE_PAREN | value operator value;

operator: PLUS | MINUS | MULTIPLY | DIVIDE | MODULO  | EQUALS | NOTEQUALS | LESS | GREATER | LESSEQUALS | GREATEREQUALS ;
...
types: UINT8 | UINT16 | UINT32 | UINT64 | INT8 | INT16 | INT32 | INT64 | FLOAT32 | FLOAT64 | STRING | CHAR | VOID;