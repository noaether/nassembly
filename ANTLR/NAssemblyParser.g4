...
value: HEX_NUMBER | FLOAT_NUMBER | BIN_NUMBER | functioncall | IDENTIFIER | STRING | CHAR | OPEN_PAREN value CLOSE_PAREN | value operator value;
...
types: UINT8 | UINT16 | UINT32 | UINT64 | INT8 | INT16 | INT32 | INT64 | FLOAT32 | FLOAT64 | STRING | CHAR;